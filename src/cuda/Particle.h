...
public:
    ...
    //updating method for position and velocity
    void updateParticlePosition(Eigen::Vector3d forces, double h);
    void updateParticleVelocity(Eigen::Vector3d forces, double h);
